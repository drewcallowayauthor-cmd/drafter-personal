...
struct SnapshotFolderNameTests {
    ...
    func roundTrips() {
        ...
        let name = SnapshotFolderName.make(date: date, machine: "Josiah-MacBook-Pro", calendar: utc)
        #expect(name == "2026-08-18 14-32-05 Josiah-MacBook-Pro")

        let parsed = SnapshotFolderName.parse(name, calendar: utc)
        #expect(parsed?.machine == "Josiah-MacBook-Pro")
    ...
    func machineNameWithSpaces() {
        ...
        let name = SnapshotFolderName.make(date: date, machine: "Josiah's Mac Studio", calendar: utc)
        #expect(SnapshotFolderName.parse(name, calendar: utc)?.machine == "Josiah's Mac Studio")
    }
