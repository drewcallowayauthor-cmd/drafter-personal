...
enum Theme {
    enum Color {
        ...
        static let accent2_100 = SwiftUI.Color(hex: 0xF5F4FF)
        static let accent2_200 = SwiftUI.Color(hex: 0xE7E5FE)
        static let accent2_300 = SwiftUI.Color(hex: 0xD2CEFD)
        static let accent2_400 = SwiftUI.Color(hex: 0xB5AFE8)
        static let accent2_500 = SwiftUI.Color(hex: 0x9690C9)
        static let accent2_600 = SwiftUI.Color(hex: 0x7972A9)
        static let accent2_700 = SwiftUI.Color(hex: 0x5C5783)
        static let accent2_800 = SwiftUI.Color(hex: 0x423E5D)
        static let accent2_900 = SwiftUI.Color(hex: 0x2B293A)
